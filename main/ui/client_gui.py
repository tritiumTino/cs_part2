...
class Ui_MainClientWindow(object):
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        MainClientWindow.setWindowTitle(_translate("MainClientWindow", "Chat alpha"))
        ...
        self.label_new_message.setText(_translate("MainClientWindow", "Enter a new message:"))
        ...
        self.menu.setTitle(_translate("MainClientWindow", "Menu"))
